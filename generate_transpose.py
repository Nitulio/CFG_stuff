...
LETTERS = {str(index - 1) : letter for index, letter in enumerate(sentences, start=1)} 
ANNOTATIONS = ['[', ']', '[[', ']]',' ']
#print(LETTERS)
def num2alpha(text):
